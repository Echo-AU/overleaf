...
ASP.NET Core opnår den højeste vægtede score og har ingen reelle svagheder i forhold til Echos krav. De afgørende faktorer er gruppens C\#-kompetencer og frameworkets indbyggede understøttelse af sikkerhed og transaktioner, som begge vægter højt. Go er stærkest på performance, skalerbarhed og asynkrone processer, men de kriterier vægter lavt for en bachelor-MVP, og manglende kompetencer udgør en betydelig risiko. Node.js har et stort ecosystem og stærk asynkron I/O, men svagere maintainability og en større afhængighed af tredjepartspakker i sikkerhedskritiske dele. Forskellen mellem Go og Node.js er så lille, at de reelt deler andenpladsen.
